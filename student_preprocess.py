...
def exploratory_analysis(df_x, df_y):
    ...
    plt.savefig("./eda/numvar_heatmap.pdf")
    ...
    plt.xticks(rotation=45, horizontalalignment='right', fontweight='light', fontsize=14)
    plt.savefig("./eda/numvar_pairplot.pdf")

    return


    # perform feature selection for the numerical input and categorical output data type we have,
    # using ANOVA correlation coefficient
    # fs = SelectKBest(score_func=f_classif, k=10)
    # fs.fit_transform(df_x, df_y)
    # use_features = fs.get_feature_names_out().tolist()

    # read_data = df_x[use_features]
    #
    # return read_data, df_y, use_features
